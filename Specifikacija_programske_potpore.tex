...
%					\textit{Funkcionalne zahtjeve razraditi u obliku obrazaca uporabe. Svaki obrazac je potrebno razraditi prema donjem predlošku. Ukoliko u nekom koraku može doći do odstupanja, potrebno je to odstupanje opisati i po mogućnosti ponuditi rješenje kojim bi se tijek obrasca vratio na osnovni tijek.}\\
				...
				\noindent \underbar{\textbf{UC15 - Stvori kolekciju/podkolekciju}}
					\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC16 - Uredi kolekciju/podkolekciju}}
					\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC17 - Ukloni kolekciju/podkolekciju}}
					\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC18 - Javi se na oglas}}
					\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC19 - Pregledaj korisnika}}
					\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC20 - Blokiraj korisnika}}
					\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC21 - Aktiviraj korisnika}}
					\begin{packed_item}
				...
				\noindent \underbar{\textbf{UC22 - Kreiraj događaj}}
					\begin{packed_item}
...
%				\textit{Nacrtati sekvencijske dijagrame koji modeliraju najvažnije dijelove sustava (max. 4 dijagrama). Ukoliko postoji nedoumica oko odabira, razjasniti s asistentom. Uz svaki dijagram napisati detaljni opis dijagrama.}
			...
			\textbf{Obrazac uporabe UC16 - Uređivanje kolekcije/podkolekcije}
				...
				\begin{figure}[H]
					\includegraphics[width=\textwidth]{slike/SD_UC16.png}
					\centering
			...
			\textbf{Obrazac uporabe UC20 - Blokiranje korisnika}
				...
				\begin{figure}[H]
					\includegraphics[scale=1.2]{slike/SD_UC20.png}
					\centering
